            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title"><span class="font-weight-bold text-danger">Timeline:</span> {{$timeline->name}}</h3>
                    </div>
                    <div class="p-3">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-danger mt-3"
                                            href="{{ Url('/admin/timeline/news/remove', $item->id) }}"><i
