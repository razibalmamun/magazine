            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">All Timeline</h3>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-danger mt-3"
                                            href="{{ Url('/admin/timeline/delete', $timeline->id) }}"><i
                                                class="fas fa-trash fa-fw"></i>Delete</a>
                                        <a class="btn btn-info mt-3"
                                            href="{{ Url('/admin/timeline/news', $timeline->id) }}"><i
                                                class="fas fa-folder fa-fw"></i>View all news</a>
                                    </td>
                                </tr>
                                <?php } ?>
                            </tbody>
